...
namespace
{
    ...
    constexpr const char* vertex_source_color = R"(
        #version 330
    ...
    constexpr const char* fragment_source_color = R"(
        #version 330
        ...
        void main()
        {
            ...
            frag_color = sampled_color * v_vertex_color;
        }
    )";
...
mono::IPipelinePtr TexturePipeline::MakeVertexColorPipeline()
{
    sg_shader_desc shader_desc = {};
    shader_desc.vs.source = vertex_source_color;
    shader_desc.attrs[ATTR_POSITION].name = "vertex_position";
    shader_desc.attrs[ATTR_UV].name = "texture_coord";
