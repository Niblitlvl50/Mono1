...
mono::IWindowPtr mono::CreateOpenGLWindow(int width, int height, bool fullscreen, IOGLSetupPtr setup)
{
    ...
    IWindowPtr window(new SDLWindow(width, height, flags, setup));
    return window;
}
